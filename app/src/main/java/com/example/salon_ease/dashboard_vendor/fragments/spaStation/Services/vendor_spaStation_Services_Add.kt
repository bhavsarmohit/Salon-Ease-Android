...
import com.example.salon_ease.databinding.FragmentVendorSpaStationServicesAddBinding
...
//        when user press back button replace fragment with vendor Home Fragment
    ...
    override fun onCreateView(
        ...
        binding.btnDone.setOnClickListener {
            ...
            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
            transaction.replace(com.example.salon_ease.R.id.frameLayout, vendor_spaStation_Services_HomeShow())
            transaction.commit()
        }
