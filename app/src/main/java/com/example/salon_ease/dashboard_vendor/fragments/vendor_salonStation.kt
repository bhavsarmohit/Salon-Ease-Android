...
import com.example.salon_ease.dashboard_vendor.fragments.salonAtHome.Services.vendor_salonAtHome_Services_HomeShow
import com.example.salon_ease.dashboard_vendor.fragments.salonAtHome.vendor_salonAtHome_BookingHistory
 ...
 * Use the [vendor_salonStation.newInstance] factory method to
 * create an instance of this fragment.
 */
class vendor_salonStation : Fragment(R.layout.fragment_vendor_salon_station) {
    ...
    //    intialize binding
    private var _binding: FragmentVendorSalonStationBinding? = null
...
//        when user press back button replace fragment with vendor Home Fragment
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVendorSalonStationBinding.inflate(inflater, container, false)


//        code here
        binding.layoutServices.setOnClickListener {
            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
            transaction.replace(R.id.frameLayout, vendor_salonStation_Services_HomeShow())
            transaction.commit()
        }
...
// imageList.add(SlideModel("String Url" or R.drawable, "title") You can add title
    ...
    companion object {
         ...
         * @return A new instance of fragment vendor_salonStation.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            vendor_salonStation().apply {
