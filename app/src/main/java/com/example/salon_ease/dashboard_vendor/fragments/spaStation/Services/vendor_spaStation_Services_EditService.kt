...
import com.example.salon_ease.databinding.FragmentVendorSpaStationServicesEditServiceBinding
 ...
 * Use the [vendor_spaStation_Services_EditService.newInstance] factory method to
 * create an instance of this fragment.
 */
class vendor_spaStation_Services_EditService : Fragment(R.layout.fragment_vendor_spa_station__services__edit_service) {
    ...
    //    intialize binding
    private var _binding: FragmentVendorSpaStationServicesEditServiceBinding? = null
...
//        when user press back button replace fragment with vendor Home Fragment
            ...
            override fun handleOnBackPressed() {
                ...
                val dialog = AlertDialog.Builder(activity!!)
                    ...
                    .setPositiveButton("Yes", { dialog, i ->
                        val fragment = vendor_spaStation_Services_HomeShow()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVendorSpaStationServicesEditServiceBinding.inflate(inflater, container, false)
...
//            SingleToast.show(activity, "Fields not Empty", Toast.LENGTH_LONG)
            ...
            var myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Name")
            myRef.setValue(serviceNm)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Desc")
            myRef.setValue(description)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Price")
            myRef.setValue(originalServicePrice)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Offer_Price")
            myRef.setValue(offerPrice)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Time")
...
//        Retrieve Data from firebase and put on Form===========
        var myRefName = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Name")
...
//        Retrieve Data from firebase and put on Form===========
        var myRefDesc = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Desc")
        // Read from the database
...
//        Retrieve Data from firebase and put on Form===========
        var myRefPrice = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Price")
        // Read from the database
...
//        Retrieve Data from firebase and put on Form===========
        var myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$serviceName/Service_Offer_Price")
        // Read from the database
...
//                SingleToast.show(, "Please enter OTP!", Toast.LENGTH_LONG);
    ...
    companion object {
         ...
         * @return A new instance of fragment vendor_spaStation_Services_EditService.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            vendor_spaStation_Services_EditService().apply {
