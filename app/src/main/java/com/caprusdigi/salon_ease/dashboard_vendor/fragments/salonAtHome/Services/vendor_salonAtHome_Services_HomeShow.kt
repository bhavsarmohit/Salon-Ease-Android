...
import com.caprusdigi.salon_ease.dashboard_vendor.fragments.vendor_SalonAtHome
import com.caprusdigi.salon_ease.databinding.FragmentVendorSalonAtHomeServicesHomeShowBinding
...
// Inflate the layout for this fragment
        ...
        binding.layoutAddService.setOnClickListener {
            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
            transaction.replace(com.caprusdigi.salon_ease.R.id.frameLayout, vendor_salonAtHome_Services_Add())
            transaction.commit()
        }
        binding.layoutRemoveService.setOnClickListener {
            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
            transaction.replace(com.caprusdigi.salon_ease.R.id.frameLayout, vendor_salonAtHome_Services_Remove())
            transaction.commit()
        }
