...
import com.caprusdigi.salon_ease.databinding.FragmentVendorSpaStationServicesAddBinding
 ...
 * Use the [vendor_spaStation_Services_Add.newInstance] factory method to
 * create an instance of this fragment.
 */
class vendor_spaStation_Services_Add : Fragment(R.layout.fragment_vendor_spa_station__services__add) {
    ...
    //    intialize binding
    private var _binding: FragmentVendorSpaStationServicesAddBinding? = null
...
//        when user press back button replace fragment with vendor Home Fragment
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVendorSpaStationServicesAddBinding.inflate(inflater, container, false)
        ...
        binding.btnAddService.setOnClickListener{
            addServiceToSpaStation()
        }
        binding.btnDone.setOnClickListener {

            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
            transaction.replace(com.caprusdigi.salon_ease.R.id.frameLayout, vendor_spaStation_Services_HomeShow())
            transaction.commit()
        }
...
//        ============================
    ...
    private fun addServiceToSpaStation() {
...
//            SingleToast.show(activity, "Fields not Empty", Toast.LENGTH_LONG)
            ...
            var myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/Service_Name")
            myRef.setValue(serviceNm)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/Service_Desc")
            myRef.setValue(description)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/Service_Price")
            myRef.setValue(originalServicePrice)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/Service_Offer_Price")
            myRef.setValue(offerPrice)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/Service_Time")
            myRef.setValue(serviceTime)


            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/First_Category")
            myRef.setValue(Cat)

            myRef = database!!.getReference("Users/$numberFir/Vendor/Spa_Station/Services/$thirdCat/Sub_Category")
...
//                SingleToast.show(, "Please enter OTP!", Toast.LENGTH_LONG);
    ...
    companion object {
         ...
         * @return A new instance of fragment vendor_spaStation_Services_Add.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            vendor_spaStation_Services_Add().apply {
